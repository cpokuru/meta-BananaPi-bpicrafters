...
SRC_URI_append = " \
    ...
    file://0001-REFPLTB-2733-To-provide-IPv6-feed-to-connected-clien.patch;apply=no \
"
...
do_rpi_patches() {
    ...
    if [ ! -e rpi_patch_applied ]; then
        ...
        patch -p1 < ${WORKDIR}/0001-REFPLTB-2733-To-provide-IPv6-feed-to-connected-clien.patch
